...
bool StartMenuState::handleInput(sf::RenderWindow& window, const sf::Vector2f& mousePos, StateID& currentStateID, bool isWin) {
...
bool LevelSelectionState::handleInput(sf::RenderWindow& window, const sf::Vector2f& mousePos, StateID& currentStateID, bool isWin) {
	for (int i = 0; i < numberOfLevels; ++i) {
...
bool LevelGameState::handleInput(sf::RenderWindow& window, const sf::Vector2f& mousePos, StateID& currentStateID, bool isWin) {
